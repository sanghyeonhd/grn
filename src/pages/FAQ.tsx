...
const FAQ = () => {
  ...
  const faqData = {
    product: [
      { q: "그랑핸드는 수제 향수 브랜드가 맞나요?", a: "그랑핸드 제품은 수제 향수가 아닙니다. 제품 생산 시 일부 공정에는 수작업이 들어가지만 모든 것을 손으로 만드는 핸드크래프트 브랜드는 아닙니다." },
      { q: "그랑핸드는 제품은 품질 실험을 하나요?", a: "" },
      { q: "SWEEPING PEONY는 왜 단종 되었나요?", a: "" },
      { q: "반려동물이 있는데 그랑핸드 제품을 사용해도 될까요?", a: "" },
      { q: "임신 중에 그랑핸드 제품을 사용해도 괜찮나요?", a: "" },
