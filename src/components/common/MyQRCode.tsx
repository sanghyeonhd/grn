        ...
        <div className="relative p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center py-4">
              <img src="/placeholder.svg" alt="QR Code" className="w-64 h-64" />
            </div>
            <div className="grid grid-cols-2 pt-4 text-center gap-8">
              <div>
                <div className="mb-1">
                  <img src="/placeholder.svg" alt="Stamp" className="w-6 h-6 mx-auto" />
                </div>
                <div className="text-sm">콤프타블 커피 스탬프</div>
              </div>
              <div>
                <div className="mb-1">
                  <img src="/placeholder.svg" alt="Calendar" className="w-6 h-6 mx-auto" />
                </div>
                <div className="text-sm">그랑핸드 패스포트</div>
              </div>
            </div>
